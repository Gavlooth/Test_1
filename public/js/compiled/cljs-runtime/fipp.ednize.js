...
var fipp$ednize$IEdn$_edn$dyn_50605 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_50605(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4652__auto__ = (function fipp$ednize$edn_$_iter__50484(s__50485){
return (new cljs.core.LazySeq(null,(function (){
var s__50485__$1 = s__50485;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__50485__$1);
if(temp__5720__auto__){
var s__50485__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50485__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50485__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50487 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50486 = (0);
while(true){
if((i__50486 < size__4651__auto__)){
var k = cljs.core._nth(c__4650__auto__,i__50486);
cljs.core.chunk_append(b__50487,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__50619 = (i__50486 + (1));
i__50486 = G__50619;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50487),fipp$ednize$edn_$_iter__50484(cljs.core.chunk_rest(s__50485__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50487),null);
}
} else {
var k = cljs.core.first(s__50485__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__50484(cljs.core.rest(s__50485__$2)));
}
} else {
return null;
}
...
var x__$1 = this;
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"ExceptionInfo","ExceptionInfo",294935087,null),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"message","message",-406056002),cljs.core.ex_message(x__$1),new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.ex_data(x__$1)], null),(function (){var temp__5720__auto__ = cljs.core.ex_cause(x__$1);
