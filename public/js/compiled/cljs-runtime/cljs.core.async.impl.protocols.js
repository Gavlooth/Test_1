...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40756 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40756(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40766 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40766(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40780 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40780(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40787 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40787(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40800 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40800(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40808 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40808(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40816 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40816(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40826 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40826(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40829 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40829(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40841 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40841(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40849 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40849(b);
}
});
