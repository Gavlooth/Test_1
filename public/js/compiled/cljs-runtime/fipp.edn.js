...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__53574,open,xs,sep,close,f){
var map__53576 = p__53574;
var map__53576__$1 = cljs.core.__destructure_map(map__53576);
var printer = map__53576__$1;
var print_level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53576__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53576__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__53582 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53582,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__53582;
}
})();
var xform = cljs.core.comp.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(print_length)?cljs.core.take.cljs$core$IFn$_invoke$arity$1(print_length):cljs.core.identity),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__53566_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(printer__$1,p1__53566_SHARP_) : f.call(null,printer__$1,p1__53566_SHARP_));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k53606,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__53633 = k53606;
var G__53633__$1 = (((G__53633 instanceof cljs.core.Keyword))?G__53633.fqn:null);
switch (G__53633__$1) {
case "symbols":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k53606,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__53635){
var vec__53640 = p__53635;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53640,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53640,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53605){
var self__ = this;
var G__53605__$1 = this;
return (new cljs.core.RecordIter((0),G__53605__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var self__ = this;
var this$__$1 = this;
var _STAR_print_dup_STAR__orig_val__53673 = cljs.core._STAR_print_dup_STAR_;
var _STAR_print_dup_STAR__temp_val__53674 = false;
(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__temp_val__53674);
...
}finally {(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__orig_val__53673);
}}));
...
var self__ = this;
var this$__$1 = this;
var temp__5718__auto__ = (function (){var G__53675 = cljs.core.first(x);
return (self__.symbols.cljs$core$IFn$_invoke$arity$1 ? self__.symbols.cljs$core$IFn$_invoke$arity$1(G__53675) : self__.symbols.call(null,G__53675));
})();
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__53679){
var self__ = this;
var map__53680 = p__53679;
var map__53680__$1 = cljs.core.__destructure_map(map__53680);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53680__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53680__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll(this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__53681){
var vec__53682 = p__53681;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53682,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53682,(1),null);
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__53685 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__53686 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__53686);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__53685);
}})()], null);
}));
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__53687 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__53688 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__53688);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__53687);
}})()], null);
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this53607,other53608){
var self__ = this;
var this53607__$1 = this;
return (((!((other53608 == null)))) && ((((this53607__$1.constructor === other53608.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53607__$1.symbols,other53608.symbols)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53607__$1.print_meta,other53608.print_meta)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53607__$1.print_length,other53608.print_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53607__$1.print_level,other53608.print_level)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53607__$1.__extmap,other53608.__extmap)))))))))))));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k53606){
var self__ = this;
var this__4509__auto____$1 = this;
var G__53694 = k53606;
var G__53694__$1 = (((G__53694 instanceof cljs.core.Keyword))?G__53694.fqn:null);
switch (G__53694__$1) {
case "symbols":
case "print-meta":
case "print-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k53606);

}
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__53605){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__53695 = cljs.core.keyword_identical_QMARK_;
var expr__53696 = k__4511__auto__;
if(cljs.core.truth_((pred__53695.cljs$core$IFn$_invoke$arity$2 ? pred__53695.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__53696) : pred__53695.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__53696)))){
return (new fipp.edn.EdnPrinter(G__53605,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53695.cljs$core$IFn$_invoke$arity$2 ? pred__53695.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__53696) : pred__53695.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__53696)))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__53605,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53695.cljs$core$IFn$_invoke$arity$2 ? pred__53695.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__53696) : pred__53695.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__53696)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__53605,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53695.cljs$core$IFn$_invoke$arity$2 ? pred__53695.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__53696) : pred__53695.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__53696)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__53605,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__53605),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__53605){
var self__ = this;
var this__4501__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__53605,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__53615){
var extmap__4542__auto__ = (function (){var G__53701 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__53615,new cljs.core.Keyword(null,"symbols","symbols",1211743),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], 0));
if(cljs.core.record_QMARK_(G__53615)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__53701);
} else {
return G__53701;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__53615),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__53615),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__53615),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__53615),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__53705 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__53706 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__53706);

try{return fipp.visit.visit(printer,x);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__53705);
}}));
