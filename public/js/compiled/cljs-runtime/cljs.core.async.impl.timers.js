...
var i_43288 = (0);
while(true){
if((i_43288 < arr.length)){
(arr[i_43288] = null);

var G__43289 = (i_43288 + (1));
i_43288 = G__43289;
continue;
} else {
}
...
var i_43311 = (self__.level + (1));
while(true){
if((i_43311 <= (new_level + (1)))){
(update[i_43311] = self__.header);

var G__43312 = (i_43311 + (1));
i_43311 = G__43312;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43314 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43314[i]));
} else {
x__$2.forward.push((((i < links_43314.length))?(links_43314[i]):null));
}

if((i < links_43314.length)){
(links_43314[i] = x__$2);
} else {
links_43314.push(x__$2);
}
...
var i_43317 = (0);
while(true){
if((i_43317 <= self__.level)){
var links_43318 = (update[i_43317]).forward;
if((x__$1 === (((i_43317 < links_43318.length))?(links_43318[i_43317]):null))){
(links_43318[i_43317] = (x__$1.forward[i_43317]));

var G__43323 = (i_43317 + (1));
i_43317 = G__43323;
continue;
} else {
var G__43324 = (i_43317 + (1));
i_43317 = G__43324;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__43339 = nx;
var G__43340 = (level__$1 - (1));
x = G__43339;
level__$1 = G__43340;
continue;
} else {
var G__43341 = x;
var G__43342 = (level__$1 - (1));
x = G__43341;
level__$1 = G__43342;
continue;
}
