...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__50456_SHARP_,p2__50454_SHARP_){
return p2__50454_SHARP_.toUpperCase();
}));
...
var G__50489 = o;
helix.impl.props.goog$module$goog$object.set(G__50489,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__50739 = cljs.core.rest(m);
var G__50740 = (function (){var entry = cljs.core.first(m);
...
var G__50546 = o1;
helix.impl.props.goog$module$goog$object.extend(G__50546,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50579_SHARP_){
if(cljs.core.map_QMARK_(p1__50579_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__50579_SHARP_);
} else {
return p1__50579_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__50765 = cljs.core.rest(m);
var G__50766 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__50775 = cljs.core.rest(m);
var G__50776 = (function (){var entry = cljs.core.first(m);
